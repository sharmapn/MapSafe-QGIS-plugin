...
class MapSafe:
    ...
    def __init__(self, iface):
        ...
        self.dlg = MapSafeDialog()
        self.dlg.setModal(True)

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr(u'&mapsafe')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'MapSafe')
        self.toolbar.setObjectName(u'MapSafe')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('MapSafe', message)
        ...
        if result:
            ...
            for layer in self.iface.mapCanvas().layers():
                if layer.type() == QgsMapLayer.VectorLayer:
                    ...
                    if result2[0]:
                        QMessageBox.warning(self.dlg, "MapSafe",\
